...
def parse_pt(pt_file,zones):
    ...
    for line in lines:
        ...
        # tid chưa có trong dsach thì thêm
...
# Phân tích độ lệch (thời gian xuất hiện của 1 đối tượng giữa các cam)
...
# Lưu từng tracklet vào dict rồi ghi vào tệp mot_path
