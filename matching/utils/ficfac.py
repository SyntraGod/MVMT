...
# Tính toán ma trận chuyển đổi P và vector trung bình
...
# Tính toán ma trận chuyển đổi cho mỗi nhãn cụ thể (label) và vector trung bình cho từng nhãn.
...
# Cập nhật đặc trưng dựa trên các trọng số xác suất từ các đặc trưng tương đồng trong tập dữ liệu.
