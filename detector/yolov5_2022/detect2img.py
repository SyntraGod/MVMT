...
# Thay đổi kihcs thước bbox để khớp kích thước ảnh gốc
...
def detect(save_img=True):
    ...
    # source la nguon anh cua buoc generate
    source, weights, view_img, save_txt, imgsz = opt.source, opt.weights, opt.view_img, opt.save_txt, opt.img_size
    
    # print('?????')
    # print(source)
    
    # Xác định nguồn đầu vào (webcam, tệp văn bản hay 1 luồng video)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    # Lưu thông tin detection dạng txt
                    # Cấu trúc: tên class, tọa độ tâm bboxes, rộng, cao, confidence score
                    ...
                    # Cat anh tung object luw vào folder
                    if True:
                        ...
                        # Lưu ảnh từng object vào folder
    ...
    # Lưu thông tin các detection vào file .pkl
